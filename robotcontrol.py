...
def project_interface():
    ...
    try:
        ...
        if result != RobotErrorType.RobotError_SUCC:
            ...
            logger.info("get_robot_state {0}".format(ret))


            ret = robot.project_startup()
            logger.info("project_startup {0}".format(ret))

            # ret = robot.enter_reduce_mode()
            # logger.info("enter_reduce_mode {0}".format(ret))
            # time.sleep(20)
            # ret = robot.exit_reduce_mode()
            # logger.info("exit_reduce_mode {0}".format(ret))

            time.sleep(20)
            
            ret = robot.rs_project_stop()
            logger.info("rs_project_stop {0}".format(ret))
...
def IK_demo():
    ...
    try:
        ...
        if result != RobotErrorType.RobotError_SUCC:
            ...
            # 基于base 法兰中心逆解
            # 运动至准备位置
            joint_radian1 = (-0.000172/180.0*pi,-7.291862/180.0*pi,-75.694718/180.0*pi,21.596727/180.0*pi,-89.999982/180.0*pi,-0.000458/180.0*pi)
            back = robot.move_joint(joint_radian1)
            logger.info("move joint to prepare waypint: {0}".format(back))
            ...
            # logger.info(robot.get_current_waypoint())
            # print(".......................................................................")
            # prepare_waypoint = robot.forward_kin( joint_radian1)
            # logger.info("prepare all joint : {0}".format(prepare_waypoint['joint']))
            # logger.info("prepare joint1 : {0}".format(prepare_waypoint['joint'][0]*180/pi))
            # logger.info("prepare joint2 : {0}".format(prepare_waypoint['joint'][1]*180/pi))
            # logger.info("prepare joint3 : {0}".format(prepare_waypoint['joint'][2]*180/pi))
            # logger.info("prepare joint4 : {0}".format(prepare_waypoint['joint'][3]*180/pi))
            # logger.info("prepare joint5 : {0}".format(prepare_waypoint['joint'][4]*180/pi))
            # logger.info("prepare joint6 : {0}".format(prepare_waypoint['joint'][5]*180/pi))
            # print(".......................................................................")
            # logger.info("move joint to prepare waypint: {0}".format(prepare_waypoint['pos']))
            # logger.info("move joint to prepare waypint: {0}".format(prepare_waypoint['ori']))
            # print("........................................................................")
            # ORI= robot.quaternion_to_rpy(prepare_waypoint['ori'])
            # logger.info("ori_x: {0}".format(ORI[0]*180/pi))
            # logger.info("ori_y: {0}".format(ORI[1]*180/pi))
            # logger.info("ori_z: {0}".format(ORI[2]*180/pi))
            # print("........................................................................")
            ...
            # print(".......................................................................")
            # logger.info("ik_result : {0}".format(ik_result['pos']))
            # logger.info("ik_result : {0}".format(ik_result['ori']))
            # print("........................................................................")
            # ORI= robot.quaternion_to_rpy(ik_result['ori'])
            # logger.info("ori_x: {0}".format(ORI[0]*180/pi))
            # logger.info("ori_y: {0}".format(ORI[1]*180/pi))
            # logger.info("ori_z: {0}".format(ORI[2]*180/pi))
            # print("........................................................................")
            ...
            # # user 带tool下的位置姿态
            # user_pos=(-0.094942,0.407438,0.000000)
            # user_ori1=(-0.000332/180.0*pi,-0.000089/180.0*pi,-29.999788/180.0*pi)
            # user_ori= robot.rpy_to_quaternion(user_ori1)


            # user_coord = {'coord_type': RobotCoordType.Robot_World_Coordinate,
            #             'calibrate_method':3 ,                                      # RobotCoordCalMethod.CoordCalMethod_xOxy
            #             'calibrate_points':
            #                 {"point1": (1.047201, -0.127267, -1.321122, 0.376934, -1.570796, -0.000008),
            #                 "point2": (1.047203, 0.259596, -0.904410, 0.406790, -1.570796, -0.000006),
            #                 "point3": (0.806954, 0.221771, -0.952863, 0.396162, -1.570794, -0.240254)},
            #             'tool_desc':
            #                 {"pos": (0.0, 0.0, 0.1),
            #                 "ori": (1.0, 0.0, 0.0, 0.0)}
            #             }
            ...
            # # 工具位置描述
            # tool_pos_on_end = (0.0, 0.0, 0.1)
            # # 工具姿态描述
            # tool_ori_on_end = (1, 0, 0, 0)
            # # 工具描述
            # user_tool = {"pos": tool_pos_on_end, "ori": tool_ori_on_end}
            
            # # user转base
            # user_base = robot.user_to_base(user_pos, user_ori, user_coord, user_tool)

            # print(".......................................................................")
            # logger.info("user_baseX,Y,Z : {0}".format(user_base['pos']))
            # logger.info("user_base : {0}".format(user_base['ori']))
            # print("........................................................................")
            # ORI= robot.quaternion_to_rpy(user_base['ori'])
            # logger.info("user_base ori_x: {0}".format(ORI[0]*180/pi))
            # logger.info("user_base ori_y: {0}".format(ORI[1]*180/pi))
            # logger.info("user_base ori_z: {0}".format(ORI[2]*180/pi))
            # print("........................................................................")
            
            # prepare_joint = (-0.000172/180.0*pi,-7.291862/180.0*pi,-75.694718/180.0*pi,21.596727/180.0*pi,-89.999982/180.0*pi,-0.000458/180.0*pi)
            
            # ik_result = robot.inverse_kin(prepare_joint, user_base['pos'], user_base['ori'])
            # logger.info("ik_result all joint : {0}".format(ik_result['joint']))
            # logger.info("ik_result joint1 : {0}".format(ik_result['joint'][0]*180/pi))
            # logger.info("ik_result joint2 : {0}".format(ik_result['joint'][1]*180/pi))
            # logger.info("ik_result joint3 : {0}".format(ik_result['joint'][2]*180/pi))
            # logger.info("ik_result joint4 : {0}".format(ik_result['joint'][3]*180/pi))
            # logger.info("ik_result joint5 : {0}".format(ik_result['joint'][4]*180/pi))
            # logger.info("ik_result joint6 : {0}".format(ik_result['joint'][5]*180/pi))




            # # 情况三
            # # base下falnge_centert添加工具
            # base_pos  = (-0.400319,-0.121499,0.547598)
            # base_ori1 = (179.999588*pi/180.0,-0.000081*pi/180.0,-89.999641*pi/180.0)
            # base_ori =robot.rpy_to_quaternion(base_ori1)
            # user_tool={"pos": (0.0, 0.0, 0.1), "ori": (1, 0, 0, 0)}
            # base_addtool = robot.base_to_base_additional_tool(base_pos, base_ori,user_tool)
           
            # logger.info("base_addtoolX,Y,Z : {0}".format(base_addtool['pos']))
            # logger.info("base_addtool : {0}".format(base_addtool['ori']))
            # print("........................................................................")
            # ORI= robot.quaternion_to_rpy(base_addtool['ori'])
            # logger.info("base_addtool ori_x: {0}".format(ORI[0]*180/pi))
            # logger.info("base_addtool ori_y: {0}".format(ORI[1]*180/pi))
            # logger.info("base_addtool ori_z: {0}".format(ORI[2]*180/pi))
            # print("........................................................................")
            ...
            # 情况四没有基于工具坐标系去做逆解，可以是加了工具，参考坐标系是base/user.
            # 带了工具的使用user to base,去除工具
            ...
            tool_pos  =(-0.400319,-0.121499,0.447598)
            tool_ori1 =(179.999588*pi/180.0,-0.000081*pi/180.0,-89.999641*pi/180.0)
            tool_ori = robot.rpy_to_quaternion(tool_ori1)
            remove_tool = robot.user_to_base(tool_pos, tool_ori, user_coord, user_tool)

            logger.info("remove_tool,X,Y,Z : {0}".format(remove_tool))
            logger.info("remove_tool : {0}".format(remove_tool))
            print("........................................................................")
            ORI= robot.quaternion_to_rpy(remove_tool['ori'])
            logger.info("remove_tool ori_x: {0}".format(ORI[0]*180/pi))
            logger.info("remove_tool ori_y: {0}".format(ORI[1]*180/pi))
            logger.info("remove_tool ori_z: {0}".format(ORI[2]*180/pi))
            print("........................................................................")

            prepare_joint = (-0.000172/180.0*pi,-7.291862/180.0*pi,-75.694718/180.0*pi,21.596727/180.0*pi,-89.999982/180.0*pi,-0.000458/180.0*pi)
            
            ik_result = robot.inverse_kin(prepare_joint, remove_tool['pos'], remove_tool['ori'])
            logger.info("ik_result all joint : {0}".format(ik_result['joint']))
            logger.info("ik_result joint1 : {0}".format(ik_result['joint'][0]*180/pi))
            logger.info("ik_result joint2 : {0}".format(ik_result['joint'][1]*180/pi))
            logger.info("ik_result joint3 : {0}".format(ik_result['joint'][2]*180/pi))
...
def test_move():
    ...
    logger.info("Move point1 successfully.")   
    ...
    logger.info("Move point2 successfully.")   
    ...
    logger.info("ok the project run has been successfully.")
